...
const PlotpointPage = ({plotpoint}) => {
  ...
  return (
    <div>
        ...
        <p>Part of the Story <Link to={`/story=${plotpoint.story}`}>{storyTitle}</Link> created by <Link to={`/user=${plotpoint.creator}`}> {creatorName}</Link></p>    
